...
namespace Canil.Controllers
{
    ...
    {
        private CanilModel canil1 = new CanilModel("Meu Canil Feliz", 2, 20, 40, 22, 48);
        private CanilModel canil2 = new CanilModel("Vai Rex", 1.7f, 15, 50, 20, 55);
        private CanilModel canil3 = new CanilModel("Chow Chawgas", 0.8f, 30, 45, 30, 45);

        [HttpPost(Name = "getUserInput")]
        public string GetUserInput(DateTime data, int caesPequenos, int caesGrandes)
        {
            List<CanilModel> canis = new List<CanilModel> { canil1, canil2, canil3 };
